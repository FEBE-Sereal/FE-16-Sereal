                ...
                <div className="card-body">
                  <div className="row">
                    ...
                    <div className="col-sm-9">
                      <p className="text-muted mb-0">Ultraman Nexus</p>
                    </div>
                  </div>
                  <hr />
                  <div className="row">
              ...
              {/* <div className="row">
                <div className="col-md-6">
                  <div className="card mb-4 mb-md-0">
                    <div className="card-body">
                      <p className="mb-4">
                        <span className="text-primary font-italic me-1">Kelas</span>
                        {"yang di ambil"}
                      </p>
                ...
                <div className="col-md-6">
                  <div className="card mb-4 mb-md-0">
                    <div className="card-body">
                      <p className="mb-4">
                        <span className="text-primary font-italic me-1">Progress Kelas</span>
                        {"yang di ambil"}
                      </p>
                      <p className="mb-1" style={{ fontSize: ".77rem" }}>
                        Web Design
